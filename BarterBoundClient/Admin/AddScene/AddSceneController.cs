...
public class AddSceneController
{
    ...
    {
        _console.WriteLine("What would you like to name the scene? (This will be the name of the file)");
    ...
    public void WriteFile(string sceneName, Models.Scene sceneBlock)
    {
